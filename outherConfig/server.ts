...
// import { generateJwtAndRefreshToken } from './middleware/auth';
// import { auth } from './config/auth';

// import {
//   checkRefreshTokenIsValid, users, seedUserStore, invalidateRefreshToken,
// } from './database';
...
//   const users = app.serialize(schema.all('user')).users.slice(pageStart, pageEnd);
